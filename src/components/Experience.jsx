...
return (
  <div className="sm:mr-10 shadow-lg lg:max-w-lg">
  <h1 className="my-4 sm:hidden text-center text-3xl font-bold">
        Experience <span className="text-red-500">Section</span>
      </h1>

  <h2 className="mt-4 ml-2 font-semibold text-indigo-600">{`Tech Matys`} <i className="text-sm">(April-September 2024)</i></h2>
  <div className="pl-6 ">
